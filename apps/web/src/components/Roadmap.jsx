...
const Roadmap = () => {
  return (
    <section id="roadmap" className="py-28 relative overflow-hidden">
      ...
      <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[600px] h-[600px] bg-accent-yellow/[0.04] rounded-full blur-[120px] pointer-events-none" />
      <div className="container mx-auto px-6 relative z-10">
        <div className="mb-20 text-center">
          ...
          >
            The <span className="text-transparent bg-clip-text bg-gradient-to-r from-accent-yellow to-white">Roadmap</span>
          </motion.h2>
          <motion.p
            initial={{ opacity: 0, y: 10 }}
            whileInView={{ opacity: 1, y: 0 }}
        ...
        <div className="relative max-w-4xl mx-auto">
          ...
          <motion.div 
            ...
            className="absolute left-1/2 transform -translate-x-1/2 w-px bg-gradient-to-b from-accent-yellow via-accent-yellow to-transparent hidden md:block"
          ></motion.div>
              ...
              return (
                ...
                >
                  ...
                  <motion.div
                    ...
                    className="z-10 flex items-center justify-center w-12 h-12 bg-[#121620] border-2 border-accent-yellow rounded-full shrink-0 my-4 md:my-0 pulse-glow group-hover:bg-accent-yellow transition-all duration-300"
                  >
                  ...
                  <motion.div
                    ...
                    className={`md:w-5/12 bg-gradient-to-b from-white/[0.05] to-transparent border border-white/[0.08] p-6 rounded-xl group-hover:border-accent-yellow/40 transition-all duration-300 w-full text-center ${isEven ? 'md:text-left' : 'md:text-right'} relative overflow-hidden`}
                  >
                    <div className="absolute top-0 left-0 right-0 h-px bg-gradient-to-r from-accent-yellow/30 via-transparent to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-300" />
                    <h3 className="text-base font-semibold text-white relative z-10 leading-snug group-hover:text-accent-yellow transition-colors duration-300">{item.title}</h3>
                  </motion.div>
                </motion.div>
              );
            })}
