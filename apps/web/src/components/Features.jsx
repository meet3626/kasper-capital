...
const Features = () => {
  return (
    <section id="features" className="py-24 relative overflow-hidden transition-colors duration-500">
      {/* Background Glows */}
      <div className="absolute top-[30%] left-[-20%] w-[1000px] h-[1000px] bg-accent-yellow/[0.03] rounded-full blur-[150px] pointer-events-none" />
      ...
      <div className="container mx-auto px-6 relative z-10">
        <div className="text-center max-w-3xl mx-auto mb-24">
          ...
          >
            What We <span className="text-transparent bg-clip-text bg-gradient-to-r from-accent-yellow to-white italic font-light">Offer</span>
          </motion.h2>
          <motion.p
            initial={{ opacity: 0, y: 20 }}
            whileInView={{ opacity: 1, y: 0 }}
            ...
            return (
              ...
              >
                ...
                <div className="w-full lg:w-1/2 relative group">
                  ...
                  <div className="aspect-[4/3] rounded-3xl border border-black/10 dark:border-white/10 bg-black/5 dark:bg-white/5 backdrop-blur-md flex items-center justify-center relative overflow-hidden group-hover:border-accent-yellow/30 transition-colors duration-500">
                    {/* Background Image */}
                    <motion.div 
                ...
                <div className="w-full lg:w-1/2 flex flex-col justify-center">
                  ...
                  <h3 className="text-2xl md:text-3xl font-bold text-gray-900 dark:text-white mb-4 tracking-tight leading-tight group-hover:text-accent-yellow transition-colors duration-300">
                    {offer.title}
                  </h3>
                  ...
                  <button className="flex items-center gap-3 text-gray-900 dark:text-white font-semibold text-sm tracking-widest uppercase group/btn w-fit">
                    <span className="group-hover/btn:text-accent-yellow transition-colors duration-300">Discover</span>
                    <span className="w-8 h-8 rounded-full border border-black/20 dark:border-white/20 flex items-center justify-center group-hover/btn:bg-accent-yellow group-hover/btn:border-accent-yellow transition-all duration-300 group-hover/btn:translate-x-2">
