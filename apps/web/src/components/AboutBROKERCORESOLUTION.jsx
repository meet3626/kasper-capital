        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-20 items-center">
          ...
          >
            <p className="text-xl text-gray-300 font-light leading-relaxed">
              Forged at the intersection of institutional finance and next-generation technology, BROKERCORESOLUTION was established with a singular mandate: to engineer uncompromised, institutional-grade brokerage infrastructure. Our heritage is rooted in delivering ultra-low latency environments and deep liquidity solutions that power the world's most demanding retail and institutional trading floors.
            </p>
            <p className="text-xl text-gray-300 font-light leading-relaxed">
...
export default AboutBROKERCORESOLUTION;
